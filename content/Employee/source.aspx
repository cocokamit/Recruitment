<%@ Page Language="C#" AutoEventWireup="true" CodeFile="source.aspx.cs" Inherits="content_Employee_source" MasterPageFile="~/content/NewMasterPage.master" %>
                ...
                <asp:Label ID="lbl_del_notify" runat="server" style=" position:absolute; right:120px; margin:15px; font-size:11px; " ></asp:Label>
                 ...
                 <asp:GridView ID="grid_view" CssClass="table table-bordered table-hover dataTable" runat="server" AutoGenerateColumns="false">
                    <Columns>
                        ...
                        <asp:BoundField DataField="description" HeaderText="Source" SortExpression="description" />
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group no-margin">
                    <label>Source</label> <asp:Label ID="lbl_loc" ForeColor="Red" runat="server" Text=""></asp:Label>
