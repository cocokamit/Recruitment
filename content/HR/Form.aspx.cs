...
public partial class content_HR_Form : System.Web.UI.Page
{
        ...
        if (dt.Rows.Count == 0)
        {
            ...
            if (checkfeilds())
            {
                try
                {
                    ...
                    string region = ddl_region.Text.Contains("|") ? ddl_region.Text.Substring(0, ddl_region.Text.IndexOf("|")) : ddl_region.Text;
                    ...
                    string country2 = ddl_country2.Text;
                    string city2 = ddl_city2.Text;
                    string region2 = ddl_region2.Text.Contains("|") ? ddl_region2.Text.Substring(0, ddl_region2.Text.IndexOf("|")) : ddl_region2.Text;
                    string province2 = ddl_province2.Text;
                    string baranggay2 = txt_baranggay2.Text.Length == 0 ? "None" : txt_baranggay2.Text.Trim();
                    string homeadd = country2 + "|" + region2 + "|" + province2 + "|" + city2 + "|" + baranggay2;


                    query += "insert into NewApplicant(LastName,FirstName,MiddleName,FullName,DateApply,PositionDesire,Address,ProvencialAddress,CellphoneNumber,PhoneNumber,EmailAddress,DateOfBirth,PositionId,Status,Review,ResumeFile,Captcha,Gender,Property)values" +
                        "('" + txt_lname.Text.Trim().Replace("'", "''") + "','" + txt_fname.Text.Trim().Replace("'", "''") + "','" + txt_mname.Text.Trim().Replace("'", "''") + "','" + txt_lname.Text.Trim().Replace("'", "''") + ", " + txt_fname.Text.Trim().Replace("'", "''") + " " + txt_mname.Text.Trim().Replace("'", "''") + "',"
                        + "GETDATE(),'" + hd_jobid.Value + "','" + present + "','" + homeadd + "','" + txt_cel.Text.Replace("'", "''") + "','" + txt_tel.Text.Replace("'", "''") + "','" + txt_email.Text.Replace("'", "''") + "','" + txt_from.Text.Replace(" ", "") + "'," +
                        "'" + hd_jobid.Value + "','New Applicant','0','" + txt_fname.Text.Replace(" ", "").Replace("'", "''") + "_" + txt_lname.Text.Replace(" ", "").Replace("'", "''") + txt_resume.Text.Replace("'", "''") + "','" + txtCaptcha.Text + "','" + ddl_gender.Text + "','" + hf_property.Value + "')";

                    query += "insert into Applicant(date_app,name,present_add,provencial_add,tel_no,cell_no,email,dateofbirth,job_id,resume_file,status,captcha,gender,property) values " +
                    "(getdate(),'" + txt_fname.Text.Trim().Replace("'", "''") + ' ' + txt_mname.Text.Trim().Replace("'", "''") + ' ' + txt_lname.Text.Trim().Replace("'", "''") + "','" + present + "','" + homeadd + "','" +
                   ...
                   "insert into Education values(@appid,'" + ddl_attainment.SelectedItem + "','" + ddl_courses.SelectedItem + "','-','-'," + hd_jobid.Value + ") ";
                    ...
                    foreach (DataRow row in employment.Rows)
                        query += "insert into EmploymentHistory(app_id,company,position,datef,datet,job_id)values(@appid,'" + row["col_1"].ToString().Trim().Replace("'", "''") + "','" + row["col_2"].ToString().Trim().Replace("'", "''") + "','" + row["col_3"].ToString().Trim().Replace("'", "''").Split('-')[0] + "','" + row["col_3"].ToString().Trim().Replace("'", "''").Split('-')[1] + "'," + hd_jobid.Value + ") ";
                ...
                if (cont)
                {
                    try
                    {
                        ...
                        string query = "insert into file_details values(" + dt.Rows[0]["id"].ToString() + ",'document/app_id_" + dt.Rows[0]["id"].ToString() + "/','" + txt_fname.Text.Replace(" ", "") + "_" + txt_lname.Text.Replace(" ", "") + "','" + contenttype.Text + "','" + txt_resume.Text + "',GETDATE())";
    ...
    protected void countrylist()
    {
        ...
        ddl_country.Items.Add("Country"); ddl_country2.Items.Add("Country");
        foreach (string val in country_arr)
        {
            ddl_country.Items.Add(val);
            ddl_country2.Items.Add(val);
        }
    }
    ...
    protected void property()
    {
        ...
        switch (url[url.Length-1].ToLower())
        {
            case "cebu":
                hd_logo.Value = "1";
                lbl_header.Text = "Cebu LandMasters";
                lbl_brr.Text = "Cebu LandMasters";
                break;
            case "cdo":
                hd_logo.Value = "2";
                lbl_header.Text = "Cebu LandMasters CDO";
                lbl_brr.Text = "Cebu LandMasters CDO";
                break;
            case "bacolod":
                hd_logo.Value = "3";
                lbl_header.Text = "Cebu LandMasters Bacolod";
                lbl_brr.Text = "Cebu LandMasters Bacolod";
                break;
            case "bogo":
                hd_logo.Value = "4";
                lbl_header.Text = "Cebu LandMasters Bogo";
                lbl_brr.Text = "Cebu LandMasters Bogo";
                break;
            case "davao":
                hd_logo.Value = "5";
                lbl_header.Text = "Cebu LandMasters Davao";
                lbl_brr.Text = "Cebu LandMasters Davao";
                break;
            case "dumaguete":
                hd_logo.Value = "6";
                lbl_header.Text = "Cebu LandMasters Dumaguete";
                lbl_brr.Text = "Cebu LandMasters Dumaguete";
                break;
            case "manila":
                hd_logo.Value = "7";
                lbl_header.Text = "Cebu LandMasters Manila";
                lbl_brr.Text = "Cebu LandMasters Manila";
                break;
        }
    ...
    protected void cebu(object sender, EventArgs e)
    {
        LinkButton2.Visible = true;
        hd_logo.Value = "1";
    ...
    protected void cdo(object sender, EventArgs e)
    {
        LinkButton2.Visible = true;
        hd_logo.Value = "2";
        lbl_brr.Text = "CDO";
    ...
    protected void bacolod(object sender, EventArgs e)
    {
        LinkButton2.Visible = true;
        hd_logo.Value = "3";
        lbl_brr.Text = "Bacolod";
        logoo.Visible = false;
        suwaatt.Visible = false;
    ...
    protected void bogo(object sender, EventArgs e)
    {
        LinkButton2.Visible = true;
        hd_logo.Value = "4";
        lbl_brr.Text = "Bogo";
    ...
    protected void davao(object sender, EventArgs e)
    {
        LinkButton2.Visible = true;
        hd_logo.Value = "5";
        lbl_brr.Text = "Davao";
    ...
    protected void dumaguete(object sender, EventArgs e)
    {
        LinkButton2.Visible = true;
        hd_logo.Value = "6";
        lbl_brr.Text = "Dumaguete";
        logoo.Visible = false;
        suwaatt.Visible = false;
    ...
    protected void manila(object sender, EventArgs e)
    {
        LinkButton2.Visible = true;
        hd_logo.Value = "7";
        lbl_brr.Text = "Manila";
