<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form.aspx.cs" Inherits="content_HR_Form" %>
...
<div id="policy" runat="server" class="PopUpPanel policy">
    Accessing our website means you agree to our privacy policy. Click <a href="company address for data privacy">here</a> to read it.
    ...
    <div class="row">
        ...
        <div class="col-b">
            ...
            <div class="col-row address">
                <div class="app-group">
                    <asp:DropDownList ID="ddl_country2" ClientIDMode="Static" CssClass="country2" runat="server"></asp:DropDownList>
                    <asp:Label ID="l_coun2" runat="server" Text="Home Address *"></asp:Label>
                </div>
                <div class="app-group">
                    <select name="country2" id="countryy2"><option>Region</option></select>
                    <asp:TextBox ID="ddl_region2" Placeholder="Region" runat="server" ClientIDMode="Static" CssClass="address-text"></asp:TextBox>
                </div>
                <div class="app-group">
                    <select name="state2" id="statey2"><option>Province</option></select> 
                    <asp:TextBox ID="ddl_province2" Placeholder="Province" autocomplete="off" ClientIDMode="Static" runat="server" CssClass="address-text"></asp:TextBox>
                </div>
                <div class="app-group">
                    <select name="city" id="cityy2"><option>City</option></select>
                    <asp:TextBox ID="ddl_city2" onkeydown ="return (event.keyCode!=13)" Placeholder="City" ClientIDMode="Static" autocomplete="off" runat="server" CssClass="address-text"></asp:TextBox>
                </div>
                <div class="app-group no-margin">
                    <asp:TextBox ID="txt_baranggay2" Placeholder="Barangay/Street" runat="server" CssClass="barang"></asp:TextBox>
                </div>
            </div>
            <div class="clearfix"></div>
            <div class="col-row address">
...
<p>This Privacy Policy (“Privacy Policy”) is provided by Cebu LandMasters with respect to the operation and management of the Jobs at Cebu LandMasters website and social media pages, and the provision of services thereunder (collectively referred to as “we”, “our”, and “us”).</p>
...
<p>By visiting/using our website at <a href="http://www.domainname.com.ph/">www.domainname.com.ph</a> or accessing our social media pages on Facebook, Instagram, Twitter, LinkedIn, and WordPress (the “Website” or the “Social Media Pages”), you are deemed to have read and agreed to be bound by this Privacy Policy.</p>
...
<li>protecting HR Recruitment interests and other ancillary or related purposes;</li>
...
<p>Our Website and Social Media Pages may contain links to websites or applications operated by third parties. We are not responsible for the privacy practices or the content of these third parties. The Privacy Policy of Cebu LandMasters applies solely to Personal Information collected by us, and does not apply to third party websites or applications.</p>
...
6000 Cebu City,<br>
Philippines</p>
<p>E-mail: <a href="mailto:gmail_address.com.ph">your@address.com.ph</a></p>
...
<div id="modalresume" runat="server" class="modal-content resume">
    ...
    <asp:TextBox ID="contenttype" runat="server" ClientIDMode="Static" CssClass="hidden"></asp:TextBox>
...
<!--End Application Form-->
            ...
            <% for (int i = 0; i < dt.Rows.Count; i++)
               {
                   ...
                   %>
                <div class="item<% Response.Write(act); %>"><img src="style/img/slider/<% Response.Write(dt.Rows[i]["f_name"].ToString()); %>" style="width:100%" alt="CebuLandmasters"></div>
    ...
    <div class="ds">
        ...
        <asp:TextBox ID="txt_search" runat="server" placeholder="Search Job..." ontextchanged="txt_TextChanged"></asp:TextBox>    
    </div>
    <div class="content-a">
        <div class="suwat" runat="server" id="suwaatt">
            <h3>Join our team. Excel with us.</h3>
            <p>
                In line with the Filipino culture of xxxxxxx, xxxxxxxx xxx xxxxxx xxxx xxxxx xxx xx x xx and other company affiliates<br />
        ...
        <div class="lnk" runat="server" id="logoo">
            ...
            <ul>
                <li>
                    <a href="cebu"><img src="site/images/photo-gallery-thumb-13.jpg" alt="CEBU"/></a>
                    <a href="cdo"><img src="site/images/photo-gallery-thumb-13.jpg" alt="CDO"/></a>
                    <a href="bacolod"><img src="site/images/photo-gallery-thumb-13.jpg" alt="BACOLOD"/></a>
                </li>
                <li>
                    <a href="bogo"><img src="site/images/photo-gallery-thumb-13.jpg" alt="BOGO"/></a>
                    <a href="davao"><img src="site/images/photo-gallery-thumb-13.jpg" alt="DAVAO"/></a>
                    <a href="dumaguete"><img src="site/images/photo-gallery-thumb-13.jpg" alt="DUMAGUETE"/></a>
                    <a href="manila"><img src="site/images/photo-gallery-thumb-13.jpg" alt="MANILA"/></a>
                </li>
            </ul>
            ...
            <ul class="hidden">
                <li>
                    <asp:LinkButton ID="lnk_cebu" OnClick="click_property" runat="server" ToolTip="Cebu" CommandName="1"><img src="style/img/logo/pangloa.png" alt="Cebu" style="margin:10px 20px 10px 20px"/></asp:LinkButton>
                    <asp:LinkButton ID="lnk_cdo" OnClick="click_property" runat="server" ToolTip="CDO" CommandName="2" ><img src="style/img/logo/maribago.png" alt="CDO" style="margin:10px 20px 10px 20px"/></asp:LinkButton>
                    <asp:LinkButton ID="lnk_bacolod" OnClick="click_property" runat="server" ToolTip="BACOLOD" CommandName="3"><img src="style/img/logo/sumilon.png" alt="Bacolod"  style="margin:10px 20px 10px 20px"/></asp:LinkButton>
                </li>
                <li>
                    <asp:LinkButton ID="lnk_bogo" OnClick="click_property" runat="server" ToolTip="BOGO" CommandName="4"><img src="style/img/logo/amuma.png" alt="Bogo"/></asp:LinkButton>
                    <asp:LinkButton ID="lnk_davao" OnClick="click_property" runat="server" ToolTip="DAVAO" CommandName="5"><img src="style/img/logo/almot.png" alt="Davao"/></asp:LinkButton>
                    <asp:LinkButton ID="lnk_dumaguete" OnClick="click_property" runat="server" ToolTip="DUMAGUETE" CommandName="6"><img src="style/img/logo/ARCHospitals.png" alt="Dumaguete"/></asp:LinkButton>
                    <asp:LinkButton ID="lnk_manila" OnClick="click_property" runat="server" ToolTip="MANILA" CommandName="7"><img src="style/img/logo/ARCHospitals.png" alt="Manila"/></asp:LinkButton>
                </li>
            </ul>
        </div>
            <div id="panel" runat="server" visible="false">
                <div id="rt">
                    ...
                    <div class="consub">
                        <% if (hd_logo.Value == "1") %>
                        <% {%>
                        <img src="style/img/logo/maribago.png" style="height:100px;" alt="Cebu LandMasters" class="logo" />
                        <% }%>

                            <% else if (hd_logo.Value == "2") %>
                        <% {%>
                        <img src="style/img/logo/pangloa.png" style="height:100px;" alt="Cebu LandMasters" class="logo" />
                        <% }%>

                            <% else if (hd_logo.Value == "3") %>
                        <% {%>
                        <img src="style/img/logo/sumilon.png" style="height:100px;" alt="Cebu LandMasters" class="logo" />
                        <% }%>

                        <% else if (hd_logo.Value == "4") %>
                        <% {%>
                        <img src="style/img/logo/almot.png" style="height:100px;" alt="Cebu LandMasters" class="logo" />
                        <% }%>

                        <% else if (hd_logo.Value == "5") %>
                        <% {%>
                        <img src="style/img/logo/amuma.png" style="height:100px;" alt="Cebu LandMasters" class="logo" />
                        <% }%>

                            <% else if (hd_logo.Value == "6") %>
                        <% {%>
                        <img src="style/img/logo/other.png" style="height:100px;" alt="Cebu LandMasters" class="logo" />
                        <% }%>
                    ...
                    <div class="consub-b">
                        ...
                        <asp:Panel ID="pnl_det" runat="server" Visible="false">
                            <ul class="ul">
                                ...
                                <li id="job" runat="server" class="li_hd pm">Qualification/s:</li>
    ...
    <script type="text/javascript">
        ...
        if (document.getElementById('ddl_country').value == "Philippines") {
         ...
         if (document.getElementById('ddl_country2').value == "Philippines") {
            $("#ddl_region2").css("display", "none");
            $("#countryy2").css("display", "block");
            $("#ddl_province2").css("display", "none");
            $("#statey2").css("display", "block");
            $("#ddl_city2").css("display", "none");
            $("#cityy2").css("display", "block");
            var reg = $('#ddl_region2').val().split("|");
            $('#countryy2 option:selected').text(reg[0]);
            provicne(reg[1]);
            $('#statey2 option:selected').text($('#ddl_province2').val());
            cityni($('#ddl_province2').val());
            $('#cityy2 option:selected').text($('#ddl_city2').val());
        }
        else {
            $("#ddl_region2").css("display", "block");
            $("#countryy2").css("display", "none");
            $("#ddl_province2").css("display", "block");
            $("#statey2").css("display", "none");
            $("#ddl_city2").css("display", "block");
            $("#cityy2").css("display", "none");
        }
          ...
          $(".country2").change(function () {
            if (this.value == "Philippines" || this.value == "Country") {
                ...
                document.getElementById('ddl_region2').value="";
                document.getElementById('ddl_city2').value= "";
                document.getElementById('ddl_province2').value="";
                $("#ddl_region2").css("display", "block");
                $("#countryy2").css("display", "none");
                $("#ddl_province2").css("display", "block");
                $("#statey2").css("display", "none");
        ...
        $.each(country_arr, function (i, item) {
               console.log("out");
            $('#countryy2').append($('<option>', {
                value: i + 1,
                text : item,
            }, '</option>' ));
            $('#countryy2 option:selected').val(0);
        });
        ...
        $('#cityy').change(function(){
          ...
          $('#countryy2').change(function(){
            console.log("country2");
            var c = $(this).val();
            document.getElementById('ddl_region2').value= $('#countryy2 option:selected').text() + "|" + c;
            var state_arr = s_a[c].split("|");
            $('#statey2').empty();
            $('#cityy2').empty();
            if(c==0){
                $('#statey2').append($('<option>', {
                    value: '0',
                    text: 'Select State',
                }, '</option>'));
            }else {
            ...
            $('#cityy2').append($('<option>', {
                value: '0',
                text: 'City',
            }, '</option>'));
        });

        $('#statey2').change(function(){
            var s = $(this).val();
            document.getElementById('ddl_province2').value= $('#statey2 option:selected').text();
            var city_arr = c_a[s].split("|");
            $('#cityy2').empty();
            $.each(city_arr, function (j, item_city) {
                $('#cityy2').append($('<option>', {
        ...
        $('#cityy2').change(function(){
            document.getElementById('ddl_city2').value= $('#cityy2 option:selected').text();
        });
