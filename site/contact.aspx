<%@ Page Title="" Language="C#" MasterPageFile="~/content/website.master" AutoEventWireup="true" CodeFile="contact.aspx.cs" Inherits="site_contact" %>

<asp:Content ID="head" ContentPlaceHolderID="head" Runat="Server">
    <style type="text/css">
        .contact-t { display:none}
    </style>
</asp:Content>
<asp:Content ID="content" ContentPlaceHolderID="content" Runat="Server">
	...
	<section class="section-contact bg1-pattern p-t-90 p-b-113">
		<div class="container">
			<h3 class="tit7 t-center p-b-62 p-t-50">
				Send us a Message
			</h3>
