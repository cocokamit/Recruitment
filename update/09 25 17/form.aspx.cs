...
public partial class form : System.Web.UI.Page
{
    ...
    protected bool checkfeilds()
    {
        ...
        l_educ.ForeColor = fromhtml(base64textarea.InnerText.Length > 0);
        l_fname.ForeColor = fromhtml(txt_fname.Text.Length > 0);
        l_mname.ForeColor = fromhtml(txt_mname.Text.Length > 0);  
    ...
    protected void click_save(object sender, EventArgs e)
    {
        if (checkfeilds())
        {
            ...
            query += "insert into applicant(date_app,name,present_add,tel_no,cell_no,email,dateofbirth,job_id,resume_file,status,captcha) values " +
            ...
            txt_fname.Text.Replace(" ", "") + "_" + txt_lname.Text.Replace(" ", "") + Path.GetExtension(FileUpload1.PostedFile.FileName) + "','For appointment','" + txtCaptcha.Text + "') set @appid = scope_identity(); " +
